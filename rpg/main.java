...
public class main {
    ...
    public static String Bienvenida() {
        ...
        String NombreUsuario = teclado.nextLine(); // OBTENER EL NOMBRE DEL JUGADOR
    ...
    public static void main(String[] args) {
        ...
        int NumeroPueblos = Pueblo(); // SELECCIONAR ORIGEN DEL PERSONAJE
        ...
        while (true) {
            ...
            if (opcion == 4 && jugador1 != null) { // MOSTRAR ESTADÍSTICAS DEL JUGADOR
                ...
                int OpcionLucha = teclado.nextInt(); // ELEGIMOS LA OPCIÓN UNO PARA QUE PODAMOS LUCHAR CON EL ENEMIGO
                if (OpcionLucha == 1) {
                    ...
                    if (opcion_caja == 1) { // SOLO FUNCIONA EL IF SI DETECTA QUE TIENES AL MENOS UNA LLAVE
                        if (jugador1.getkeys() >= 1) {
                            ...
                            String[] recompensas = { "+100 de dinero", "+50 de dinero", "+20 puntos de ataque",
                                    ...
                                    "El rotu gastao" };
                            int randomIndex = (int) (Math.random() * recompensas.length); // CON EL RANDOM SACAMOS UNO
